...
description: Why I love making things, what I've learned, how you can make nice things too.
category: blogs
start: 2022-12-23
end: 2023-01-01
status: in-progress
...
This is all to say that the 2 hours I spent in the jewelry aisle googling everything about handmade bracelets were completely justified. 

In retrospect, I made it much, much harder than it should've been. 
...
It's entirely possible (and probably likely) that I am not using the proper name, but what I mean by tying a knot in reverse is this: imagine you have two separate strings (or a pair of wired earbuds, the most natural medium for knotting) which are both anchored on one end, you thread them through a ring and perform a series of loops, crosses, etc. which becomes a knot on the ring. 
...
Usually, the moves needed to make the same knot from one direction are entirely different from the opposite direction. 
...
Making something, whether physical or digital, is the empirical validation to your theories. Why don't we understand stars that well? Because we can't hang a black hole on a pendulum and watch it swing. It's so difficult to verify anything not on our scale, so take advantage of the things you can empirically verify.
...
You look online for gift guides, browse the homepage of Amazon, walk into a gift shop, yet everything is prohibitively expensive and nothing seems to fit into that narrow intersection of things that are nice, fits the gift recipient, and inexpensive.
...
You learn so much along the way, and though an unyielding stubbornness to your idea will bring many difficulties, they are precisely what will force you to be creative.
